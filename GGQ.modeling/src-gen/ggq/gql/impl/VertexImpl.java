 ...
 * </p>
 * <ul>
 *   <li>{@link ggq.gql.impl.VertexImpl#getType <em>Type</em>}</li>
 *   <li>{@link ggq.gql.impl.VertexImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VertexImpl extends MinimalEObjectImpl.Container implements Vertex {
	...
	protected org.eclipse.emf.ecore.EClass eStaticClass() {
		return ModelingPackage.Literals.VERTEX;
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelingPackage.VERTEX__ID, oldId, id));
	}
